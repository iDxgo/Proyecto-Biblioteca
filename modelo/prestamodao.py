...
class PrestamoDAO:
    ...
    def insertarPrestamo(self):
        self.bd.establecerConexionBD()
        sp = "exec [dbo].[sp_CrearPrestamo] @UsuarioID=?, @LibroID=?, @FechaPrestamo=?, @FechaDevolucion=?, @FechaDevolucionReal=?, @Estado=?"
    ...
    def actualizarPrestamo(self):
        self.bd.establecerConexionBD()
        sp = "exec [dbo].[sp_ActualizarPrestamo] @PrestamoID=?, @UsuarioID=?, @LibroID=?, @FechaPrestamo=?, @FechaDevolucion=?, @FechaDevolucionReal=?, @Estado=?"
    ...
    def eliminarPrestamo(self):
        self.bd.establecerConexionBD()
        sp = "exec [dbo].[sp_BorrarPrestamo] @PrestamoID=?"
    ...
    def buscarPrestamo(self):
        self.bd.establecerConexionBD()
        cursor = self.bd.conexion.cursor()
        sp = "exec [dbo].[sp_ConsultarPrestamo] @PrestamoID=?"
